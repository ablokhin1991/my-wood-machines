...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const faqData = [
    {
      question: "Как купить станок?",
      answer: "Позвоните по телефону +7 (910) 092-82-79. Мы расскажем о состоянии станка, ответим на вопросы и согласуем все детали покупки. Формы заказа на сайте нет — вся коммуникация только по телефону, чтобы вы получили живой ответ на все вопросы."
    },
    {
      question: "Можно ли приехать посмотреть станок и запустить его?",
      answer: "Да, вы можете приехать к нам во Владимирскую область (Александровский район) и лично осмотреть любой станок. Мы покажем оборудование, при необходимости запустим его в работе, чтобы вы убедились в исправности. Договоритесь о визите по телефону заранее."
    },
    {
      question: "Как организуется доставка по России?",
    ...
    {
      question: "Возможен ли торг и скидки?",
      answer: "Да, торг уместен. Окончательная цена согласовывается по телефону. Мы готовы обсудить индивидуальные условия, особенно при покупке нескольких единиц оборудования."
    },
    {
      question: "Какие гарантии на б/у станки?",
    ...
    {
      question: "Можно ли забронировать станок на несколько дней?",
    ...
    {
      question: "Вы посредники или собственники?",
