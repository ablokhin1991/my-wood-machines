const machines = [
  {
    ...
    oldPrice: 1299000,
    description:
    <p>Состояние отличное, все работает! Станок подключен, можно проверить.
       Станина станка выполнена из тяжелого литого металла с особой обработкой, что полностью гасит вибрации во время работы и обеспечивает выпуск изделий высокого качества.
       Шпиндели высокой скорости и повышенной точности гарантируют стабильность обработки.
       Подающие столы сделаны из стали 40Х с хромовым покрытием для долговечности и износоустойчивости. Механизм подачи рассредоточенного типа с верхними и нижними роликами обеспечивает ровное движение заготовки.
       Привод подачи реализован через электродвигатель с двухступенчатыми шкивами на валу двигателя и модулях. Шкивы трёхручьевые с применением стандартных клиновых ремней, а шкив на валу модулей свободно перемещается, создавая четыре постоянные передачи. В сочетании с частотным преобразователем диапазон скоростей подачи достигает 2–40 м/мин, что позволяет легко протягивать любые заготовки.
       Верхние ролики оснащены механическими прижимами для работы даже при низких отрицательных температурах, а по желанию их можно оснастить пневматической системой с плавной регулировкой давления, индивидуально для каждого ролика. Рифление «волчий зуб» верхних роликов обеспечивает эффективную обработку древесины любой влажности с минимальным вдавливанием.
       Система аспирации рассчитана на 2000 м³/ч на один суппорт, что обеспечивает чистоту рабочей зоны.
