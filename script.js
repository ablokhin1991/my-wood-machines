const machines = [
  {
    ...
    oldPrice: 1299000,
    description: `
  <p class="desc-intro">Состояние <strong>отличное</strong>, все работает! Станок подключен, можно проверить.</p>
  <p class="desc-body">Станина станка выполнена из тяжелого литого металла с особой обработкой, что полностью гасит вибрации во время работы.</p>
  <p class="desc-body">Шпиндели высокой скорости и повышенной точности гарантируют стабильность обработки.</p>
`
