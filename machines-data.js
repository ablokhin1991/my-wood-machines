...
const machines = [
  ...
  {
    id: 28,
    name: "Станок круглопалочный КПА-20-50 ДСПО",
    type: "Другие",
    kind: "Круглопалочный",
    manufacturer: "ДСПО",
    country: "Россия",
    year: "-",
    power: "4,5",
    dimensions: "1120х840х1105",
    weight: 400,
    instock: 1,
    images: [
      "images/wood-machines/stanok-kruglopalochnyy-kpa-20-50-dspo.webp",
      "images/wood-machines/stanok-kruglopalochnyy-kpa-20-50-dspo-2.webp",
      "images/wood-machines/stanok-kruglopalochnyy-kpa-20-50-dspo-3.webp"
    ],
    price: 55000,
    oldPrice: 75000,
    description: "Продаем станок для изготовления круглых палок / черенков. Круглопалочный станок КПА-20-50 предназначен для изготовления деталей цилиндрической формы, с диаметром от Ø 15 до Ø 50 мм.  Принцип работы: Подлежащая обточке заготовка передними подающими роликами подводится к резцовой головке, вращающейся полым шпинделем. На резцовой головке устанавливается от одного до пяти резцов. После выхода из шпинделя обточенного конца заготовки последняя удаляется с помощью задних подающих роликов. Станина станка отлита из чугуна и имеет форму коробки. Станок в хорошем, рабочем состоянии.",
    uniqueSpecs: [
      { label: "Макс. диаметр обрабатываемой заготовки, мм", value: "15 - 50" },
      { label: "Мин. длина обрабатываемой заготовки, мм", value: 500 },
      { label: "Скорость подачи, м/мин", value: "7,5 / 12,5 / 17 / 30" },
      { label: "Частота вращения ножевой головки, об/мин", value: 4500 },
      { label: "Мощность, кВт", value: "4,5" },
      { label: "Габариты ДxШxВ, мм", value: "1120х840х1105" },
      { label: "Масса, кг", value: 400 },
      { label: "Производитель", value: "ДСПО" },
      { label: "Страна", value: "Россия" },
      { label: "Год", value: "-" }
    ],
    status: "active"
