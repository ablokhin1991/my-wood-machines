...
const machines = [
  ...
  {
    id: 16,
    name: "Двухшпиндельный фрезер станок Бакаут СФ 003",
    type: "Фрезерный",
    kind: "Горизонтальный",
    manufacturer: "Бакаут",
    country: "Россия",
